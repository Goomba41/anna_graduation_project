<template>
  <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24">
    <mask id="lineMdFileMinusTwotone0">
      <g fill="none" stroke="#fff" stroke-linecap="round" stroke-linejoin="round" stroke-width="2">
        ...
        >
          <set fill="freeze" attributeName="fill-opacity" begin="1s" to="1"></set>
        </path>
    ...
    <rect width="24" height="24" fill="currentColor" mask="url(#lineMdFileMinusTwotone0)"></rect>
  </svg>
</template>

<script lang="ts">
export default {
  name: 'FileMinusTwotone',
}
</script>
